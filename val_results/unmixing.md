...
| 항목 | 논문 | 원저자 | 현재 구현 | 상태 |
|------|------|--------|-----------|------|
| **입력 패치 크기** | 64×64 | 64×64 | **64** | ✅ |
| **에포크** | 200 | 200 | **200** | ✅ |
| **배치 사이즈** | 32 | 32 | **32** | ✅ |
| **Spatial ViT patch size** | 2 | 2 | **2** | ✅ |
| **스펙트럼 토큰 수** | 64 | 64 | **64** | ✅ |
| **Sparsity 손실 (α)** | 0.35 | 0.35 | **0.35** | ✅ |
| **TV 손실 (β)** | 0.1 | 0.1 | **0.1** | ✅ |
| **재구성 손실** | SAD | SAD | **SAD** | ✅ |
| **학습률** | - | 0.001 | **0.001** | ✅ |
...
| 항목 | 원저자 코드 | 현재 구현 | 상태 |
|------|-------------|-----------|------|
| Endmember 초기화 | VCA | 미구현 | ⚠️ |
| 데이터 증강 | RandomFlip | 미구현 | ⚠️ |
...
| 에포크 | 50 | 200 ✅ |
| 배치 사이즈 | 64 | 32 ✅ |
| Spatial ViT patch size | 1 | 2 ✅ |
| 스펙트럼 토큰 수 | 100 | 64 ✅ |
| Sparsity 손실 | 미구현 | α=0.35 ✅ |
| TV 손실 | 미구현 | β=0.1 ✅ |
| 학습률 | 1e-4 | 0.001 ✅ |
| Weight Decay | 0.01 | 0.05 ✅ |
| Layer Decay | 미적용 | 0.9 ✅ |
| Scheduler eta_min | 1e-6 | 0 ✅ |
...
1. **VCA 초기화**: Endmember 초기값을 VCA로 설정
2. **데이터 증강**: RandomHorizontalFlip, RandomVerticalFlip 추가

**Unmixing 태스크 핵심 설정 검증 완료** ✅
