"""Layer decay optimizer constructor for Vision Transformers."""
...
def get_num_layer_for_vit(var_name: str, num_max_layer: int) -> int:
    """
    Get layer index for a parameter in ViT.

    Args:
        var_name: Name of the parameter.
        num_max_layer: Maximum number of layers.

    Returns:
        Layer index for the parameter.
    """
...
class LayerDecayOptimizerConstructor_ViT(DefaultOptimWrapperConstructor):
    ...
    Applies different learning rates to different layers, with deeper layers
    ...
    def add_params(self, params, module, prefix='', is_dcn_module=None):
        ...
        print(f"Build LayerDecayOptimizerConstructor {layer_decay_rate} - {num_layers}")
        ...
        if rank == 0:
            ...
            print(f"Param groups = {json.dumps(to_display, indent=2)}")
